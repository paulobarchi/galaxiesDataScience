...
print "len(sdssCatalog) = " + str(len(sdssCatalog))
print 'Total unique sdssCatalog: ', len(pd.unique(sdssCatalog['dr7objid'].values))
print "len(merged) = " + str(len(merged))
print 'Total unique merged: ', len(pd.unique(merged['dr7objid'].values))
