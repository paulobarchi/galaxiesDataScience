...
undefBy5ClassBy4 = merged[ (merged['class_y'] == 'U') & (merged['class_x'] != 'U') ]


classCols = ['class_x', 'class_y']
print undefBy5ClassBy4[classCols]

print len(undefBy5ClassBy4[classCols])

columnsRenamed = ['Id', 'class_4metrics', 'class_5metrics', 'Error']
undefBy5ClassBy4.columns = columnsRenamed

undefBy5ClassBy4.to_csv(sys.argv[3], index=False)
